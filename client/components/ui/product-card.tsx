    ...
    >
      ...
      <CardFooter className="p-4 pt-0 space-y-2">
        <div className="flex gap-2 w-full">
          <Button
            onClick={() => {
              // Create complete product object for cart
              const product = {
                id,
                name,
                price,
                ...
                <div className="space-y-4">
                        ...
                        <Button
                          onClick={() => {
                            ...
                            const alternativeProduct = {
                              id: layer1Alternative.id || `${id}_alt1`,
                              name: layer1Alternative.name,
                              price: layer1Alternative.price,
                              co2: co2 * 0.7, // Assume 30% less CO2 for alternatives
                              ecoScore: layer1Alternative.ecoScore,
                              isSustainable: layer1Alternative.isSustainable,
                              image: layer1Alternative.image,
                              category: layer1Alternative.category,
                            };
                            onAddToCart?.(alternativeProduct);
                    ...
                    <Card className="border-eco-300 bg-eco-50">
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <Button
                            onClick={() => {
                              if (layer1Alternative.layer2Alternative) {
                                // Create complete product object for cart
                                const bestAlternative = {
                                  id:
                                    layer1Alternative.layer2Alternative.id ||
                                    `${id}_alt2`,
                                  name: layer1Alternative.layer2Alternative
                                    .name,
                                  price:
                                    layer1Alternative.layer2Alternative.price,
                                  co2: co2 * 0.5, // Assume 50% less CO2 for best alternatives
                                  ecoScore:
                                    layer1Alternative.layer2Alternative
                                      .ecoScore,
                                  isSustainable:
                  ...
                  <div className="flex justify-between pt-4">
                    <Button
                      variant="outline"
                      onClick={() => {
                        // Create complete original product object for cart
